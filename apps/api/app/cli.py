"""Local CLI — connect, ingest, draft, review, publish, and audit."""
import json
import sys
...
from app.modules.integrations import service as consent_mod
...
from app.config.settings import SCHEDULE_CHOICES, SUPPORTED_PLATFORMS
